...
>
	...
	>
		<div class="mb-3 flex items-center gap-2">
			...
			<span class="font-mono text-[10px] tracking-[0.16em] text-(--text) uppercase"
				>Confirm Delete</span
			>
		</div>

		<p class="mb-5 font-mono text-[13px] text-(--muted)">
		...
		<div class="flex justify-end gap-2">
			...
			<button
				bind:this={focusEl}
				type="button"
				class="cursor-pointer border border-[#ff6b6b] bg-[#ff6b6b] px-4 py-1.5 font-mono text-[11px] font-medium tracking-[0.12em] text-(--bg) uppercase transition-opacity hover:opacity-80"
				onclick={onConfirm}
			>
				Delete
			</button>
